...
const router = new VueRouter({
    routes: [
        ...
        {
            path: '/index',
            component: index, children: [{ path: 'chart', component: chart, meta: { title: '数据概览' } }, { path: 'user', component: user, meta: { title: '用户列表' } }, { path: 'question', component: question, meta: { title: '题库列表' } }, { path: 'enterprise', component: enterprise, meta: { title: '企业列表' } }, { path: 'subject', component: subject, meta: { title: '学科列表' } },]
        },
        //路由重定向
        {
            path: '/',
